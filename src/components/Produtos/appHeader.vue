...
<template>
  <header>
  <div class="h1-icon">  <RouterLink to="/">
      <img src="../../../public/logoUBSDigital.png" alt="Logo UBS Digital" width="80px" class="logo">
    </RouterLink>
...
header {
font-family: "Nunito Sans", sans-serif;  display: flex;
  align-items: center;
